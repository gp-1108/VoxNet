...
save_path="${project_dir}/ModelNet40Voxel.zip"
...
# Run the script
cd $project_dir
singularity exec --bind /ext:/ext $sif_image_path python3 dataset_converter.py --input_dir $dataset_path --output_dir $dataset_output --num_workers 4
